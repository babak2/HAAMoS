...
/**
 * Extends Repast OMMultiLayer 
 */

public class ExtendedOMMultiLayer extends OMGraphicHandlerLayer implements DataBoundsProvider{
    ...
    public void setTitle(String title) {
     ...
     public ExtendedOMMultiLayer(ExtendedOpenMapDisplay omDisplay, String title) {
    	 //System.out.println("CCCCCC  ExtendedOMMultiLayer constructor");
...
class MultiCancelMoveAction extends AbstractAction {
    OMGraphic omg;
    ExtendedOMMultiLayer layer;
    
    public MultiCancelMoveAction(String name, ExtendedOMMultiLayer layer) {
        super(name);
        this.layer = layer;
    }
...
class MultiMoveAction extends AbstractAction {
    ...
    public MultiMoveAction(String name, OMGraphic omg, ExtendedOMMultiLayer layer) {
        super(name);
        this.omg = omg;
        this.layer = layer;
    }
...
class MultiUndoMoveAction extends AbstractAction {
    ...
    public MultiUndoMoveAction(String name, ExtendedOMMultiLayer layer) {
        super(name);
        this.layer = layer;
    }
